...
const PlatformHighlights = () => {
  ...
  return <section className="bg-white py-[10px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-[30px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {highlights.map((highlight, index) => <div key={index} className="bg-gradient-to-br from-gray-50 to-purple-50 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 group">
        ...
        <div className="text-center mt-16">
          <button className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-8 rounded-full hover:from-purple-700 hover:to-blue-600 transition-all duration-200 font-semibold shadow-lg py-[16px]">
