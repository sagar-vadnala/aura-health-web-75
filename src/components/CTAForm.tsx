          ...
          <div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-500 text-white px-6 py-3 rounded-lg hover:from-purple-700 hover:to-blue-600 transition-all duration-200 font-semibold shadow-lg"
                >
                  Get Started Today
                </button>
          ...
          <div className="space-y-8">
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mt-2"></div>
                  <p className="text-gray-700">HIPAA-compliant and secure infrastructure</p>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-purple-500 rounded-full mt-2"></div>
            ...
            <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl p-6">
              <h4 className="text-xl font-semibold text-gray-900 mb-3">Trusted by Healthcare Professionals</h4>
              <p className="text-gray-700 mb-4">
                Join over 1,000+ healthcare providers who have transformed their practice with Hikigai AI
              </p>
