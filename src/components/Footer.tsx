...
const Footer = () => {
  return <footer className="bg-gray-900 text-white py-[20px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-6">
              <img src="/lovable-uploads/8c785304-4280-47e5-a110-02136e53f8cf.png" alt="Hikigai AI Logo" className="h-8 w-8 mr-3" />
              <span className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                Hikigai AI
              </span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">Transforming healthcare through AI innovation.</p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400 py-0">
