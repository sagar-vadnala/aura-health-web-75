        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative z-10">
                ...
                <div className="bg-white rounded-2xl overflow-hidden">
                  <div className="bg-gradient-to-r from-purple-600 to-blue-500 h-10 flex items-center px-6">
                    ...
                    <div className="flex-1 text-center">
                      <span className="text-white text-sm font-medium">AI Scribe - Live Transcription</span>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                        ...
                        <div className="space-y-2">
                          <p className="text-sm text-gray-800">"Patient presents with chest pain radiating to left arm..."</p>
                          <p className="text-sm text-blue-600 bg-blue-50 p-2 rounded">"AI Note: Potential cardiac symptoms detected. Recommend ECG."</p>
                          <p className="text-sm text-gray-800">"Blood pressure 140/90, pulse 88 bpm..."</p>
                        </div>
                      </div>
                      
                      <div className="grid grid-cols-2 gap-2">
                        <div className="px-3 py-2 bg-purple-100 text-purple-700 rounded-lg text-xs font-medium text-center">
              ...
              {/* Mobile Screen */}
              <div className="absolute -bottom-12 -right-8 bg-gray-900 rounded-3xl p-3 shadow-xl transform -rotate-12 hover:rotate-0 transition-transform duration-300">
                <div className="bg-white rounded-2xl overflow-hidden w-48">
                  <div className="bg-gradient-to-r from-purple-600 to-blue-500 h-8 flex items-center justify-center relative">
                  ...
                  <div className="p-4 h-64">
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <div className="text-xs font-medium text-gray-900">Live Scribe</div>
                      </div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-2 space-y-1">
                        <div className="text-xs text-gray-600">"Patient vitals stable..."</div>
                        <div className="text-xs text-blue-600 bg-blue-50 p-1 rounded">AI: Normal range</div>
                      </div>
                      
                      <div className="grid grid-cols-1 gap-1">
                        <div className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs text-center">
                          BP: 120/80
                        </div>
                        <div className="px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs text-center">
                          HR: 72 bpm
                        </div>
                      </div>
                    </div>
