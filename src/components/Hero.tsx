        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="relative bg-gray-800 rounded-2xl p-1 shadow-2xl">
              <div className="bg-white rounded-xl overflow-hidden w-[600px] h-[360px]">
                ...
                <div className="p-6 h-full bg-white overflow-hidden">
            ...
            <div className="absolute -bottom-8 -right-20 bg-black rounded-3xl p-1 shadow-xl w-[120px] h-[240px]">
